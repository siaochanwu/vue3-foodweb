...
export default {
  ...
  methods: {
    getData (page) {
      ...
      console.log(page)
      const api = `${process.env.VUE_APP_API}/api/${process.env.VUE_APP_CUSTOMER}/admin/products?page=${page}`
    ...
    deleteProduct () {
      var vm = this
      const api = `${process.env.VUE_APP_API}/api/${process.env.VUE_APP_CUSTOMER}/admin/product/${vm.tempProduct}`
    ...
    updateProduct () {
      const vm = this
      let api =
        `${process.env.VUE_APP_API}/api/${process.env.VUE_APP_CUSTOMER}/admin/product`
      let httpMethod = 'post'
      if (!vm.isNew) {
    ...
    uploadFile () {
      ...
      const api =
        `${process.env.VUE_APP_API}/api/${process.env.VUE_APP_CUSTOMER}/admin/upload`
